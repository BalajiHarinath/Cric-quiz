export { default as HeroImage } from "./Images/Hero-img.jpg";
export { default as IPLTrophy } from "./Images/IPL-Trophy.jpg";
export { default as ODITrophy } from "./Images/ODI-worldcup.jpg";
